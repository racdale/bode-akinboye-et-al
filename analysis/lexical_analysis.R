...
# setwd('data/REAL')
# interlocs = list(folders=c('g1','g1'),labels=c('Leno','Alin'),
#                  g1=c('*LENO:'),
#                  g2=c('*ALIN:'))
...
windowed.auto[is.na(windowed.auto)] = 0
windowed.crqa[is.na(windowed.crqa)] = 0
windowed.part[is.na(windowed.part)] = 0
windowed.inv[is.na(windowed.inv)] = 0

save(file='lexical.overall.Rd',all.crqa.res,all.group2.res,all.group1.res,all.auto.res,interlocs,windowed.crqa,windowed.auto,windowed.part,windowed.inv)

load("lexical.overall.Rd")
